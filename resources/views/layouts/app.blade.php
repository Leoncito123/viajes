   ...
   <aside id="default-sidebar" class="fixed top-36 py-2 left-0 px-4 z-40 w-64  h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto rounded-lg bg-white border border-indigo-400 border-lg dark:bg-gray-800 dark:border-gray-700">
         <ul class="space-y-2 font-medium">
            ...
            <li>
               <a href="/volar" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
               <a href="/hoteles" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
               <a href="/mich/usuarios" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
   ...
   <div class="py-4  lg:mr-4 sm:ml-64">
      <div class=" dark:border-gray-700 border border-indigo-400 border-lg rounded-lg bg-blue-500 p-6 flex items-center">
