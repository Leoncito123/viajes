        ...
        <div class="p-4 md:p-5">
            <form class="space-y-4 w-full" action="{{ route('admin.hoteles.create') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="hotel-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre
                            del
                            Hotel</label>
                    ...
                    <div>
                        <label for="check-in" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fecha
                            de
                            Check-in</label>
                    ...
                    <div>
                        <label for="check-out" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fecha de
                            Check-out</label>
                        <input type="date" name="check-out" id="check-out"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                    </div>
                    <div>
                        <label for="rooms" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Número de
                            habitaciones</label>
                    ...
                    <div>
                        <label for="distance" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Distancia
                            al
                            centro</label>
                    ...
                    <div>
                        <label for="file" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Imagen
                            del
                            hotel</label>
                ...
                <div>
                    <label for="map" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Seleccionar
                        ubicación
                        en el mapa</label>
