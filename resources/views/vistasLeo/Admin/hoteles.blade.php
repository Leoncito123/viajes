        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md overflow-x-auto">
            <div class="max-w-md mx-auto">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="searchHotel"
                        class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Buscar hotel" />
                </div>
            </div>
            <div class="overflow-x-auto relative">
                <table class="min-w-full text-sm text-left text-gray-500 dark:text-gray-400" id="tableHoteles">
                    <thead
                        class="text-xs text-gray-700 uppercase bg-indigo-500 text-white dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="md:sticky md:left-0 z-10 px-6 py-3 bg-indigo-500">
                                Nombre
                            </th>
                    ...
                    <tbody>
                        ...
                        @else
                            @foreach ($hoteles as $hotel)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <th scope="row"
                                        class="md:sticky md:left-0 z-10 px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white bg-white dark:bg-gray-800">
                                        {{ $hotel->name }}
                                    </th>
                                    <th scope="row"
                                    ...
                                    <div class="flex items-center justify-center min-h-screen">
                                        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md w-full max-w-3xl">
                                            <div class="flex justify-between items-center">
                                                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Imágenes del
                                                    Hotel
                                                </h2>
