...
@section('content')
    ...
    {{-- HEADER --}}
    <div class="flex items-center justify-between bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md mb-6">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="overflow-x-auto mb-8 rounded-xl shadow-lg">
            <table id="fly-table" class="table-auto w-full bg-white dark:bg-gray-800 shadow-md rounded-lg">
                <thead class="bg-gray-800 text-white rounded-sm">
                    <tr>
                        <th class="px-4 py-2">
                            Aerolina
                            <input type="text" id="filter-airline" class="text-black rounded-xl w-full mt-1" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Numero de vuelo
                            <input type="text" id="filter-fly-number" class="text-black rounded-xl w-full mt-1" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Fecha de Salida
                            <input type="date" id="filter-departure-date" class="rounded-xl text-black w-full mt-1"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Fecha de Llegada
                            <input type="date" id="filter-arrival-date" class="w-full mt-1 rounded-xl text-black " oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Duración
                            <input type="number" id="filter-duration" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Avión
                            <input type="text" id="filter-airplane" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Destino
                            <input type="text" id="filter-destination" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Asientos
                            <input type="number" id="filter-seats" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Asientos vendidos
                        ...
                        <th class="px-4 py-2">
                            Costos
                            <input type="text" id="filter-costs" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Escalas
                            <input type="text" id="filter-scales" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                    </tr>
                </thead>
        ...
        <div class="overflow-x-auto mb-8 rounded-xl shadow-lg">
            <table id="hotel-table" class="table-auto w-full bg-white dark:bg-gray-800 shadow-md rounded-lg">
                <thead class="bg-gray-800 text-white">
                    <tr>
                        <th class="px-4 py-2">
                            Nombre del Hotel
                            <input type="text" id="filter-hotel-name" class="text-black rounded-xl w-full mt-1" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Descripción
                            <input type="text" id="filter-description" class="text-black rounded-xl w-full mt-1" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Teléfono
                            <input type="text" id="filter-phone" class="text-black rounded-xl w-full mt-1" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Estrellas
                            <input type="number" id="filter-stars" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Distancia al Centro
                            <input type="number" id="filter-distance" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Destino
                            <input type="text" id="filter-hotel-destination" class="text-black w-full mt-1 rounded-xl"
                                placeholder="Filtrar" oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Servicios
                            <input type="text" id="filter-services" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                        <th class="px-4 py-2">
                            Habitaciones
                            <input type="number" id="filter-rooms" class="text-black w-full mt-1 rounded-xl" placeholder="Filtrar"
                                oninput="applyFilter()">
                        </th>
                    </tr>
                </thead>
