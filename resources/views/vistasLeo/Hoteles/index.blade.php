                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="rooms" id="rooms" 
                                class="w-full px-4 py-2 border rounded-md focus:ring-blue-500 focus:border-blue-500" min="1" value="1">
                        </div>
                        <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            @for ($i = 1; $i <= 5; $i++)
                                <label class="inline-flex items-center space-x-2">
                                    <input type="checkbox" name="stars[]" value="{{ $i }}" class="form-checkbox">
                                    <span>{{ $i }} ⭐</span>
                                </label>
                            @endfor
                        </div>
                ...
                @foreach ($hoteles as $hotel)
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                        <div class="relative h-48">
                            <img src="{{ asset('storage/' . $hotel->pictures->first()->name) }}" 
