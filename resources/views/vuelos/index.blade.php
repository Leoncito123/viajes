                            ...
                            @foreach ($flies as $fly)
                                <div class="border border-indigo-400  rounded-lg     h-auto p-2">
                                    <div class="flex p-4 ">
                                        ...
                                        <div class="p-4">
                                            <p class="">Destino: <span class="font-semibold">{{$fly->name}}</span></p>
                                    ...
                                    <a href="{{route('vuelos.show', ['id_fly'=>$fly->id])}}" class="flex bg-indigo-500 text-white rounded-lg p-2 mx-auto justify-center" style="">Ver detalles del Vuelo
