...
<div class="max-w-8xl px-6">
    <header class="flex items-center justify-between py-10">
        <div class="flex-1"></div> <!-- centra la imagen del logo -->
        <img src="{{ asset('imagenesMich/logo.png') }}" alt="Logo" class="h-24 w-auto mx-auto" />
	...
	<div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
		<div class="mr-auto place-self-center lg:col-span-7">
			<h1
				...
				Turismo <br>sin Mapas.</h1>
				<p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Explora el mundo con nosotros: en nuestro sitio web de viajes encontrarás las mejores recomendaciones para destinos inolvidables, guías prácticas, y consejos de expertos para que planifiques el viaje perfecto. Desde escapadas urbanas hasta aventuras en la naturaleza, nos encargamos de ofrecerte inspiración y recursos para que tu próxima experiencia sea única y sin complicaciones. ¡Comienza a descubrir el mundo hoy!<a
						href="#" target="_blank" class="hover:underline"></a><a href="#/"
						class="hover:underline" target="_blank"></a> <a href="https://flowbite.com/blocks/" target="_blank"
						class="hover:underline" target="_blank"></a>.</p>
		</div>
		<div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
			<img src="{{asset('imagenesMich/inicio.jpg')}}" alt="hero image">
</div>
		</div>
</section> <!-- Termina la seccion de bienvenida -->
...
<!-- component -->
    ...
    <div class="sliderAx h-auto">
        <div id="slider-1" class="container mx-auto">
            <div class="bg-cover bg-center  h-auto text-white py-24 px-10 object-fill" style="background-image: url({{asset('imagenesMich/carruselVuelos.jpg')}})">
        <div class="md:w-1/2">
...
<!-- inicia las cartas de los hoteles -->
    ...
    <div class="grid md:grid-cols-4 gap-4 text-center mx-auto">
...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="p-8 rounded-t-lg" src="{{asset('imagenesMich/ibisHotel.jpg')}}" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Ibis Hotel</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="p-8 rounded-t-lg" src="{{asset('imagenesMich/sandosCaracol.jpeg')}}" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Sandos Hotel eco Green Resort</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="p-8 rounded-t-lg" src="{{asset('imagenesMich/xcaret.webp')}}" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Hotel Xcaret Cancun</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
...
<section class="bg-gray-50 dark:bg-gray-800">
	<div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
		<figure class="max-w-screen-md mx-auto">
			...
			<blockquote>
				<p class="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">"Gran experiencia, disfrutamos mucho del viaje."</p>
			</blockquote>
			<figcaption class="flex items-center justify-center mt-6 space-x-3">
				<img class="w-6 h-6 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png" alt="profile picture">
				<div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
					<div class="pr-3 font-medium text-gray-900 dark:text-white">Micheal Gough</div>
					<div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Las Brisas Huatulco</div>
				</div>
			</figcaption>
		</figure>
	</div>
</section>
<!-- termina la parte de testimonios de usuarios -->
<br>
<section class="bg-white dark:bg-gray-900">
...
<span>Politica de cancelaciones?</span>
...
<span>Formas y metodos de pago?</span>
...
<span>Que hacer si no recibo mi confirmacion?</span>
<svg data-accordion-icon="" class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
</button>
				</h3>
...
<span>Que hacer en caso de emergencia?</span>
<svg data-accordion-icon="" class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
</button>
				</h3>
